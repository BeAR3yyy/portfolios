...
const Highlight = ({ children }) => (
    <span className='text-neutral md:font-medium'>
        {children}
    </span>
);
...
export default function Home() {
    ...
    return (
        <div className='flex flex-col px-8 py-16 gap-16 items-center justify-center'>
            ...
            <div className='flex flex-col py-16 gap-8 md:max-w-7xl'>
                <div className='flex flex-col gap-2 text-2xl font-semibold md:flex-row md:text-4xl md:mb-4'>
                    Let Me <div className='text-neutral-focus'>Introduce</div> Myself
                </div>
                <Paragraph>
                ...
                <Link href={'/about'} className='mt-4 w-48 md:w-64'>
                    <button className="btn bg-secondary text-base-100 border-0 w-48 md:w-64">
                        <CgMoreO />
                        See more
                    </button>
                </Link>
            ...
            <div className='flex flex-col py-16 gap-8 md:max-w-7xl'>
                <div className='flex gap-2 text-2xl font-semibold md:text-4xl md:mb-4'>
                    My <div className='text-neutral-focus'>Recent</div> Works
                </div>
            ...
            <div className='flex flex-col py-16 gap-8 md:w-full md:max-w-[80rem]'>
                <div className='flex gap-2 text-2xl font-semibold md:text-4xl md:mb-4'>
                    You can <div className='text-neutral-focus'>Find Me</div> on
                </div>
